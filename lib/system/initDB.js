...
function initDB(m, client) {
  ...
  settings.banner ??= 'https://i.postimg.cc/kMVBKsq9/file-000000009a14720ea5bbc3c55c054459.png'
  settings.icon ??= 'https://cdn.yuki-wabot.my.id/files/6Z4w.jpeg'
  settings.currency ??= 'Pesos'
  settings.namebot ??= 'CHES'
  settings.botname ??= 'CHESTER'  
  settings.owner ??= ''
